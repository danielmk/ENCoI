...
[ge_proximal,gi_proximal,VC_proximal,~] = ...
                                      find_gegi_forDistal(proximal_gm.V(1:end-1),...
                                      proximal_gm.ac*1e-9,...
                                      1/proximal_gm.dt,...
...
%intermediate_gm.reversals = [-0.065 0.02 -0.085];
[ge_intermediate,gi_intermediate,VC_intermediate,~] = ...
                                      ...
                                      searchtime,...
                                      'FILTP', FILTP);
  gl_intermediate = G0new;
[ge_mixed,gi_mixed,VC_mixed,~] = ...
                                      find_gegi_forDistal(mixed_gm.V(1:end-1),...
                                      mixed_gm.ac*1e-9,...
                                      1/mixed_gm.dt,...
                                      mixed_gm.reversals,...
                                      searchtime,...
...
p1 = [20.0000   -5.0000   21.0011   17.4190];
set(gcf,'position',p1)
