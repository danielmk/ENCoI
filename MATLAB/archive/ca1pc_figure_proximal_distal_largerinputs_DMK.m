...
load('.\data\gm_distal_withdendrites_largerinputs.mat');
...
load('.\data\sece_distal_withdendrites_largerinputs.mat')
ge_vclamp = g - mean(g(1:1000));
load('.\data\seci_distal_withdendrites_largerinputs.mat')
