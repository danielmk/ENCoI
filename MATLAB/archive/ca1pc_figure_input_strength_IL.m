...
load('gm_somatic_withdendrites_smallconductances.mat');
...
load('sece_somatic_withdendrites_smallconductances.mat')
ge_vclamp = g - mean(g(1:1000));
load('seci_somatic_withdendrites_smallconductances.mat')
gi_vclamp = g - mean(g(1:1000));
...
xlabel('time (s)')
ylabel('Voltage (V)')
title('Voltage With Dendrites Somatic Inputs Conductances/10')
