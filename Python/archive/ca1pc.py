...
ei_delay = 2  # in ms
t_stim = 400  # time_point of the stimulation
...
# vi = - 130
vrs = 0.1  # access resistance 50.0 for gm and 1.0 for voltage clamp
amp_curr = 0.5  # peak to peak amplitude of injected current (nA)
